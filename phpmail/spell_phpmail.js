...
// --------------------------------------------------------------------
        ...
        function openspell()
        {
          height = 391;
          width = 555;
          if (ie4) LinkToField = self.sendfrm.emailbody;
          if (gecko) {
            LinkToField = parent.document.sendfrm.emailbody;
            height = height + 6;
          }
          if (op6) {
             LinkToField = document.forms[0].emailbody;
             height = height + 10;
             width = width + 10;
          }
          if (op7) LinkToField = document.forms[0].emailbody;
          if ((op6 || op7) && LinkToField == null) LinkToField = document.forms[1].emailbody;
