...
// Styles
if (typeof(Title_Body_Color) == "undefined") var Title_Body_Color = "#1F7FB0";
if (typeof(Title_Style) == "undefined") var Title_Style = "color:#ffffff;font-size : 11px; font-family: Verdana;";
if (typeof(Title_CSS) == "undefined") var Title_CSS = "";
...
function Do_No_Bad_Words(First_Check)
{
  ...
  if (Title_CSS != "") odoc.write("<link rel=stylesheet href='"+Title_CSS+"' type='text/css'>");
  odoc.write("</head>");
  ...
  if (First_Check) {
    ...
    odoc.write("<input type='button' value='"+Language_Text[2]+"' id='clbutton' onclick='this.blur();parent.window.close();'><br>");
  } else {
    ...
    odoc.write("<input type='button' value='"+Language_Text[2]+"' id='clbutton' onclick='this.blur();parent.Return_Valid_Sentance();'><br>");
    odoc.write("<input type='button' value='"+Language_Text[3]+"' id='clbutton' onclick='parent.window.close();'>");
  }
...
//  if (Title_CSS != "") odoc.write("<link rel=stylesheet href='"+Title_CSS+"' type='text/css'>");
  ...
  odoc.write("<input type='button' value='"+Language_Text[5]+"' id='clbuttonsmall' onclick='this.blur();parent.Correct_Word("+The_Current_Word_ID+",document.cword.word.value, true);'>");
  odoc.write("<input type='button' value='"+Language_Text[6]+"' id='clbuttonall' onclick='this.blur();parent.Correct_All_Words("+The_Current_Word_ID+",document.cword.word.value);'><br>");
  odoc.write("<input type='button' value='"+Language_Text[7]+"' id='clbuttonsmall' onclick='this.blur();parent.Ignore_Word("+The_Current_Word_ID+");'>");
  odoc.write("<input type='button' value='"+Language_Text[6]+"' id='clbuttonall' onclick='this.blur();parent.Ignore_All_Words("+The_Current_Word_ID+");'><br>");
  if (!op6) {
    odoc.write("<input type='button' value='"+Language_Text[8]+"' class='mainoption' id='clbutton' onclick='this.blur();parent.Learn_Word("+The_Current_Word_ID+");'><br>");
    odoc.write("<input type='button' value='"+Language_Text[9]+"' class='mainoption' id='clbutton' onclick='this.blur();parent.Suggest_Word("+The_Current_Word_ID+",document.cword.word.value);'><br>");
  }
  odoc.write("<input type='button' value='"+Language_Text[10]+"' class='mainoption' id='clbuttonhalf' onclick='this.blur();parent.Open_Definition(document.cword.word.value);'>");
  odoc.write("<input type='button' value='"+Language_Text[11]+"' class='mainoption' id='clbuttonhalf' onclick='this.blur();parent.Open_Thesaurus(document.cword.word.value);'><br>");

  odoc.write("<br><input type='button' value='"+Language_Text[2]+"' class='mainoption' id='clbutton' onclick='this.blur();parent.Return_Valid_Sentance();'><br>");
  odoc.write("<input type='button' value='"+Language_Text[3]+"' class='mainoption' id='clbutton' onclick='parent.window.close();'>");
