// --------------------------------------------------------------------
// phpSpell Javascript (For the Message Document)
//
...
// --------------------------------------------------------------------
        ...
        function openspell()
        {
          height = 391;
          width = 555;
          if (ie4) LinkToField = self.composeform.tmessage;
          if (gecko) {
            LinkToField = parent.document.composeform.tmessage;
            height = height + 6;
          }
          if (op6) {
             LinkToField = document.forms[0].tmessage;
             height = height + 10;
             width = width + 10;
          }
          if (op7) LinkToField = document.forms[0].tmessage;
